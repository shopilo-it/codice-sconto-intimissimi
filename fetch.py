#!/usr/bin/env python3
"""
Recupero codici sconto Intimissimi da shopilo.it
Sursa: https://shopilo.it/negozi/intimissimi.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/intimissimi.com"
STORE_NAME = "Intimissimi"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Intimissimi da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-intimissimi)"
    }
    try:
